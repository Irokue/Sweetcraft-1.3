...
public class GuiUtils extends GuiScreen
{
    ...
    protected void mouseClicked(int i, int j, int k)
    {
        ...
        if(playerNameTextField.isFocused() && playerNameTextField.getText() == "Pseudo")
    		playerNameTextField.setText("");
        if(moneyPayTextField.isFocused() && moneyPayTextField.getText() == "Montant")
    ...
    protected void keyTyped(char par1, int par2)
    {
        ...
        if (par2 == 1 || par2 == mc.gameSettings.keyBindSweetcraft.keyCode && !playerNameTextField.isFocused() || par2 == mc.gameSettings.keyBindInventory.keyCode && !playerNameTextField.isFocused())
        {
            mc.thePlayer.closeScreen();
        }
