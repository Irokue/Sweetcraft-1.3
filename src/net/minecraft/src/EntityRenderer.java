...
public class EntityRenderer
{
    ...
    private void orientCamera(float par1)
    {
        ...
        if (var2.isPlayerSleeping())
        {
            ...
            if (!this.mc.gameSettings.debugCamEnable)
            {
                ...
                {
                    int var12 = this.mc.theWorld.getBlockMetadata(MathHelper.floor_double(var2.posX), MathHelper.floor_double(var2.posY), MathHelper.floor_double(var2.posZ));
                    int var13 = var12 & 3;
        ...
        else if (this.mc.gameSettings.thirdPersonView > 0)
        {
            ...
            if (this.mc.gameSettings.debugCamEnable)
            {
                var29 = this.prevDebugCamYaw + (this.debugCamYaw - this.prevDebugCamYaw) * par1;
            ...
            else
            {
                ...
                double var14 = (double)(-MathHelper.sin(var29 / 180.0F * (float)Math.PI) * MathHelper.cos(var28 / 180.0F * (float)Math.PI)) * var27;
                double var16 = (double)(MathHelper.cos(var29 / 180.0F * (float)Math.PI) * MathHelper.cos(var28 / 180.0F * (float)Math.PI)) * var27;
    ...
    private void updateLightmap()
    {
        ...
        if (var1 != null)
        {
            if (CustomColorizer.updateLightmap(var1, this, this.lightmapColors))
            {
    ...
    public void updateCameraAndRender(float par1)
    {
        ...
        this.mc.mcProfiler.profilerGlobalEnabled = this.mc.gameSettings.ofProfiler;
        byte var10 = 10;
        ...
        if (Thread.currentThread().getPriority() != var10)
        {
        ...
        {
            this.lastTexturePack = this.mc.texturePackList.getSelectedTexturePack().func_77538_c();
        }

        if (!this.lastTexturePack.equals(this.mc.texturePackList.getSelectedTexturePack().func_77538_c()))
        {
        ...
        if (!this.mc.skipRenderWorld)
        {
            ...
            ScaledResolution var11 = new ScaledResolution(this.mc.gameSettings, this.mc.displayWidth, this.mc.displayHeight);
            int var12 = var11.getScaledWidth();
            int var13 = var11.getScaledHeight();
            int var14 = Mouse.getX() * var12 / this.mc.displayWidth;
            int var16 = var13 - Mouse.getY() * var13 / this.mc.displayHeight - 1;
            int var15 = func_78465_a(this.mc.gameSettings.limitFramerate);
            ...
            if (this.mc.theWorld != null)
            {
                ...
                {
                    this.renderWorld(par1, this.renderEndNanoTime + (long)(1000000000 / var15));
                }
                ...
                if (!this.mc.gameSettings.hideGUI || this.mc.currentScreen != null)
                {
                    ...
                    this.mc.ingameGUI.renderGameOverlay(par1, this.mc.currentScreen != null, var14, var16);
            ...
            {
                GL11.glClear(256);
                this.mc.currentScreen.drawScreen(var14, var16, par1);
    ...
    private void updateFogColor(float par1)
    {
        ...
        int var6 = var2.provider.worldType;
        ...
        {
            Vec3 var12 = MathHelper.sin(var2.getCelestialAngleRadians(par1)) > 0.0F ? Vec3.getVec3Pool().getVecFromPool(-1.0D, 0.0D, 0.0D) : Vec3.getVec3Pool().getVecFromPool(1.0D, 0.0D, 0.0D);
        ...
        if (this.mc.gameSettings.anaglyph)
        {
            float var24 = (this.fogColorRed * 30.0F + this.fogColorGreen * 59.0F + this.fogColorBlue * 11.0F) / 100.0F;
            float var19 = (this.fogColorRed * 30.0F + this.fogColorGreen * 70.0F) / 100.0F;
