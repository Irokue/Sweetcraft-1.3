...
public ModelCheval()
{
 ...
 Shape3.addBox(0F, -6F, 0F, 1, 2, 2);
 Shape3.setRotationPoint(1.5F, -6F, -11F);
 ...
 head.addBox(-4.5F, -4F, -9F, 6, 4, 12);
 head.setRotationPoint(1.5F, -6F, -11F);
 ...
 Shape2.addBox(-4F, -6F, 0F, 1, 2, 2);
 Shape2.setRotationPoint(1.5F, -6F, -11F);
 ...
 model.rotateAngleZ = z;
	...
	public void setRotationAngles(float par1, float par2, float par3, float par4, float par5, float par6)
	{
	   // head.rotateAngleX = par5 / (180F / (float)Math.PI);
	    ...
	    Shape2.rotateAngleY= par4 / (180F / (float)Math.PI);

	    Shape3.rotateAngleY= par4 / (180F / (float)Math.PI);
