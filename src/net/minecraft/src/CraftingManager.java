...
public class CraftingManager {
	...
	addRecipe(new ItemStack(Item.chopeVide, 1), new Object[] { "# #", "# #", "###", Character.valueOf('#'), Block.planks });

	addRecipe(new ItemStack(Block.table, 1), new Object[] { "###", "S S", "S S", '#', Block.planks, 'S', Item.stick });
	addRecipe(new ItemStack(Block.chaise, 1), new Object[] { "  S", "###", "S S", '#', Block.planks, 'S', Item.stick });
	addRecipe(new ItemStack(Item.vinVide, 1), new Object[] { "S S", "S S", "SSS", 'S', Block.glass });
	addRecipe(new ItemStack(Block.stoneSingleSlab, 6, 6), new Object[] { "SSS", 'S', Block.foin });
	addRecipe(new ItemStack(Block.stoneSingleSlab, 6, 7), new Object[] { "SSS", 'S', Block.netherBrick });
	addShapelessRecipe(new ItemStack(Item.vin, 1), new Object[] { Item.raisin, Item.vinVide });
	addShapelessRecipe(new ItemStack(Item.maille, 2), new Object[] { Item.ingotIron });
	addShapelessRecipe(new ItemStack(Item.chopeBiere, 1), new Object[] { Item.orge, Item.chopeVide });
	addShapelessRecipe(new ItemStack(Item.liquideSuspect, 1), new Object[] { Item.glassBottle, Item.chopeBiere, Item.vin });
	addShapelessRecipe(new ItemStack(Item.bolLait, 1), new Object[] { Item.bowlEmpty, Item.bucketMilk });
