...
public class CustomColorizer
{
    ...
    public static void update(RenderEngine var0)
    {
        ...
        if (Config.isCustomColors())
        {
            ...
            {
                var1[var2] = getCustomColors("/environment/lightmap" + (var2 - 1) + ".png", var0, -1);
    ...
    public static boolean updateLightmap(World var0, EntityRenderer var1, int[] var2)
    {
        if (var0 == null)
        {
            return false;
        ...
        {
            int var3 = var0.provider.worldType;

            if (var3 >= -1 && var3 <= 1)
            {
                int var4 = var3 + 1;
                float[][] var5 = lightMapsColorsRgb[var4];
                ...
                else
                {
                    ...
                    if (var7 < 16)
                    {
                        Config.dbg("Invalid lightmap width: " + var7 + " for: /environment/lightmap" + var3 + ".png");
                        lightMapsColorsRgb[var4] = (float[][])null;
                        return false;
                    }
                    else
                    {
                        float var8 = 1.1666666F * (var0.func_72971_b(1.0F) - 0.2F);
                        ...
                        float var9 = var8 * (float)(var7 - 1);
                        float var10 = Config.limitTo1(var1.torchFlickerX + 0.5F) * (float)(var7 - 1);
                        float var11 = Config.limitTo1(Config.getMinecraft().gameSettings.gammaSetting);
                        boolean var12 = var11 > 1.0E-4F;
                        getLightMapColumn(var5, var9, 0, var7, sunRgbs);
                        getLightMapColumn(var5, var10, 16 * var7, var7, torchRgbs);
                        ...
                        for (int var14 = 0; var14 < 16; ++var14)
                        {
                            for (int var15 = 0; var15 < 16; ++var15)
                            {
                                ...
                                {
                                    float var17 = Config.limitTo1(sunRgbs[var14][var16] + torchRgbs[var15][var16]);

                                    if (var12)
                                    {
                                        float var18 = 1.0F - var17;
                                        var18 = 1.0F - var18 * var18 * var18 * var18;
                                        var17 = var11 * var18 + (1.0F - var11) * var17;
                                    }

                                    var13[var16] = var17;
                                }

                                var16 = (int)(var13[0] * 255.0F);
                                int var19 = (int)(var13[1] * 255.0F);
                                int var20 = (int)(var13[2] * 255.0F);
                                var2[var14 * 16 + var15] = -16777216 | var16 << 16 | var19 << 8 | var20;
                            }
                        }
