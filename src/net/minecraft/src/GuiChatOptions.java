...
public class GuiChatOptions extends GuiScreen {
	...
	public void initGui(){
        ...
        global = new GuiCheckBox(1, displayX + 5, displayY + 20, "Global", mc.gameSettings.getOptionOrdinalValue(EnumOptions.SEE_GLOBAL), mc);
        commerce = new GuiCheckBox(2, displayX + 5 + 20 + 10 + fontRenderer.getStringWidth("Global"), displayY + 20, "Commerce", mc.gameSettings.getOptionOrdinalValue(EnumOptions.SEE_COMMERCE), mc);
        local = new GuiCheckBox(3, displayX + 5 + 40 + 20 + fontRenderer.getStringWidth("Global") + fontRenderer.getStringWidth("Commerce"), displayY + 20, "Local", mc.gameSettings.getOptionOrdinalValue(EnumOptions.SEE_LOCAL), mc);
        talkGlobal = new GuiRadioButton(4, displayX + 5, displayY + 60, "Global", true, mc);
        talkCommerce = new GuiRadioButton(5, displayX + 5 + 20 + 10 + fontRenderer.getStringWidth("Global"), displayY + 60, "Commerce", true, mc);
        talkLocal = new GuiRadioButton(6, displayX + 5 + 40 + 20 + fontRenderer.getStringWidth("Global") + fontRenderer.getStringWidth("Commerce"), displayY + 60, "Local", true, mc);
