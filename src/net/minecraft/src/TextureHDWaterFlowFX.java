...
public class TextureHDWaterFlowFX extends TextureFX implements TextureHDFX
{
    ...
    public void setTexturePackBase(TexturePackBase var1)
    {
    ...
    public void onTick()
    {
        ...
        if (this.imageData != null)
        {
            ...
            for (int var15 = 0; var15 < this.tileWidth * this.tileWidth; ++var15)
            {
                ...
                this.imageData[var15 * 4 + 0] = (byte)var7;
                this.imageData[var15 * 4 + 1] = (byte)var8;
                this.imageData[var15 * 4 + 2] = (byte)var9;
                this.imageData[var15 * 4 + 3] = (byte)var10;
            }
        }
    }
}
