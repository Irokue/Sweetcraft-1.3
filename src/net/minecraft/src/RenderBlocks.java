...
public class RenderBlocks
{
    ...
    public boolean renderBlockRedstoneWire(Block par1Block, int par2, int par3, int par4)
    {
        ...
        var14 = (var7 & 15) << 4;
        var15 = var7 & 240;
        double var35 = (double)((float)var14 / 256.0F);
        ...
        if (var32 != 0)
        {
            var35 = (double)((float)(var14 + 16) / 256.0F);
        ...
        if (var32 == 0)
        {
            ...
            var5.addVertexWithUV((double)var28, (double)par3 + 0.015625D, (double)var30, var35, var20);
            var5.addVertexWithUV((double)var28, (double)par3 + 0.015625D, (double)var31, var35, var22);
            ...
            var5.addVertexWithUV((double)var28, (double)par3 + 0.015625D, (double)var30, var35, var20 + 0.0625D);
            var5.addVertexWithUV((double)var28, (double)par3 + 0.015625D, (double)var31, var35, var22 + 0.0625D);
        }
        else if (var32 == 1)
        {
            var5.addVertexWithUV((double)var29, (double)par3 + 0.015625D, (double)var31, var18, var22);
        ...
        {
            var5.addVertexWithUV((double)var29, (double)par3 + 0.015625D, (double)var31, var18, var22);
            var5.addVertexWithUV((double)var29, (double)par3 + 0.015625D, (double)var30, var35, var22);
            var5.addVertexWithUV((double)var28, (double)par3 + 0.015625D, (double)var30, var35, var20);
            var5.addVertexWithUV((double)var28, (double)par3 + 0.015625D, (double)var31, var18, var20);
            var5.setColorOpaque_F(var8, var8, var8);
            var5.addVertexWithUV((double)var29, (double)par3 + 0.015625D, (double)var31, var18, var22 + 0.0625D);
            var5.addVertexWithUV((double)var29, (double)par3 + 0.015625D, (double)var30, var35, var22 + 0.0625D);
            var5.addVertexWithUV((double)var28, (double)par3 + 0.015625D, (double)var30, var35, var20 + 0.0625D);
        ...
        if (!this.blockAccess.isBlockNormalCube(par2, par3 + 1, par4))
        {
            ...
            if (this.blockAccess.isBlockNormalCube(par2 - 1, par3, par4) && this.blockAccess.getBlockId(par2 - 1, par3 + 1, par4) == Block.redstoneWire.blockID)
            {
                ...
                var5.addVertexWithUV((double)par2 + 0.015625D, (double)(par3 + 0), (double)(par4 + 1), var35, var20);
                var5.addVertexWithUV((double)par2 + 0.015625D, (double)(par3 + 0), (double)(par4 + 0), var35, var22);
                ...
                var5.addVertexWithUV((double)par2 + 0.015625D, (double)(par3 + 0), (double)(par4 + 1), var35, var20 + 0.0625D);
                var5.addVertexWithUV((double)par2 + 0.015625D, (double)(par3 + 0), (double)(par4 + 0), var35, var22 + 0.0625D);
            ...
            {
                var5.setColorOpaque_F(var8 * var10, var8 * var11, var8 * var12);
                var5.addVertexWithUV((double)(par2 + 1) - 0.015625D, (double)(par3 + 0), (double)(par4 + 1), var35, var22);
                ...
                var5.addVertexWithUV((double)(par2 + 1) - 0.015625D, (double)(par3 + 0), (double)(par4 + 0), var35, var20);
                var5.setColorOpaque_F(var8, var8, var8);
                var5.addVertexWithUV((double)(par2 + 1) - 0.015625D, (double)(par3 + 0), (double)(par4 + 1), var35, var22 + 0.0625D);
                ...
                var5.addVertexWithUV((double)(par2 + 1) - 0.015625D, (double)(par3 + 0), (double)(par4 + 0), var35, var20 + 0.0625D);
            }
            ...
            {
                var5.setColorOpaque_F(var8 * var10, var8 * var11, var8 * var12);
                var5.addVertexWithUV((double)(par2 + 1), (double)(par3 + 0), (double)par4 + 0.015625D, var35, var22);
                ...
                var5.addVertexWithUV((double)(par2 + 0), (double)(par3 + 0), (double)par4 + 0.015625D, var35, var20);
                var5.setColorOpaque_F(var8, var8, var8);
                var5.addVertexWithUV((double)(par2 + 1), (double)(par3 + 0), (double)par4 + 0.015625D, var35, var22 + 0.0625D);
                ...
                var5.addVertexWithUV((double)(par2 + 0), (double)(par3 + 0), (double)par4 + 0.015625D, var35, var20 + 0.0625D);
            }
            ...
            if (this.blockAccess.isBlockNormalCube(par2, par3, par4 + 1) && this.blockAccess.getBlockId(par2, par3 + 1, par4 + 1) == Block.redstoneWire.blockID)
            {
                ...
                var5.addVertexWithUV((double)(par2 + 1), (double)(par3 + 0), (double)(par4 + 1) - 0.015625D, var35, var20);
                var5.addVertexWithUV((double)(par2 + 0), (double)(par3 + 0), (double)(par4 + 1) - 0.015625D, var35, var22);
                ...
                var5.addVertexWithUV((double)(par2 + 1), (double)(par3 + 0), (double)(par4 + 1) - 0.015625D, var35, var20 + 0.0625D);
                var5.addVertexWithUV((double)(par2 + 0), (double)(par3 + 0), (double)(par4 + 1) - 0.015625D, var35, var22 + 0.0625D);
        ...
        if (Config.isBetterSnow() && this.hasSnowNeighbours(par2, par3, par4))
        {
            double var33 = Block.snow.maxY;
            Block.snow.maxY = 0.01D;
            this.renderStandardBlock(Block.snow, par2, par3, par4);
            Block.snow.maxY = var33;
        }
    ...
    public boolean renderBlockMinecartTrack(BlockRail par1BlockRail, int par2, int par3, int par4)
    {
        ...
        if (Config.isBetterSnow() && this.hasSnowNeighbours(par2, par3, par4))
        {
            double var44 = Block.snow.maxY;
            Block.snow.maxY = 0.05D;
            this.renderStandardBlock(Block.snow, par2, par3, par4);
            Block.snow.maxY = var44;
        }
    ...
    public void drawCrossedSquares(Block par1Block, int par2, double par3, double par5, double par7)
    {
        ...
        if (Config.isConnectedTextures() && this.overrideBlockTexture < 0)
        {
            var11 = ConnectedTextures.getConnectedTexture(this.blockAccess, par1Block, (int)par3, (int)par5, (int)par7, -1, var10);

            if (var11 >= 0)
            {
                var12 = var11 / 256;
                var9 = Tessellator.instance.getSubTessellator(var12);
                var10 = var11 % 256;
            }
        }
    ...
    public boolean renderStandardBlockWithColorMultiplier(Block par1Block, int par2, int par3, int par4, float par5, float par6, float par7)
    {
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3 - 1, par4, 0))
        {
            var10.setBrightness(par1Block.minY <= 0.0D ? par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3 - 1, par4) : var28);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3 + 1, par4, 1))
        {
            var10.setBrightness(par1Block.maxY >= 1.0D ? par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3 + 1, par4) : var28);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 - 1, 2))
        {
            var10.setBrightness(par1Block.minZ <= 0.0D ? par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3, par4 - 1) : var28);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2, par3, par4 + 1, 3))
        {
            var10.setBrightness(par1Block.maxZ >= 1.0D ? par1Block.getMixedBrightnessForBlock(this.blockAccess, par2, par3, par4 + 1) : var28);
            var10.setColorOpaque_F(var20, var23, var26);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2 - 1, par3, par4, 4))
        {
            var10.setBrightness(par1Block.minX <= 0.0D ? par1Block.getMixedBrightnessForBlock(this.blockAccess, par2 - 1, par3, par4) : var28);
        ...
        if (this.renderAllFaces || par1Block.shouldSideBeRendered(this.blockAccess, par2 + 1, par3, par4, 5))
        {
            var10.setBrightness(par1Block.maxX >= 1.0D ? par1Block.getMixedBrightnessForBlock(this.blockAccess, par2 + 1, par3, par4) : var28);
            var10.setColorOpaque_F(var21, var24, var27);
    ...
    public void renderBottomFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        {
            NaturalProperties var46 = NaturalTextures.getNaturalProperties(var9.textureID, par8);

            if (var46 != null)
            {
                var11 = Config.getRandom((int)par2, (int)par4, (int)par6, 0);

                if (var46.rotation > 1)
                {
                    this.uvRotateBottom = var11 & 3;
                }
                ...
                if (var46.flip)
                {
                    this.flipTexture = (var11 & 4) != 0;
                }
            }
        }

        double var47 = par1Block.minX;
        double var12 = par1Block.maxX;
        double var14 = par1Block.minZ;
        double var16 = par1Block.maxZ;

        if (var47 < 0.0D || var12 > 1.0D)
        {
            var47 = 0.0D;
            var12 = 1.0D;
        }

        if (var14 < 0.0D || var16 > 1.0D)
        {
            var14 = 0.0D;
            var16 = 1.0D;
        }
        ...
        int var18 = (par8 & 15) << 4;
        int var19 = par8 & 240;
        double var20 = ((double)var18 + var47 * 16.0D) / 256.0D;
        double var22 = ((double)var18 + var12 * 16.0D - 0.01D) / 256.0D;
        double var24 = ((double)var19 + var14 * 16.0D) / 256.0D;
        double var26 = ((double)var19 + var16 * 16.0D - 0.01D) / 256.0D;
        double var28;
        ...
        {
            var20 = ((double)var18 + var14 * 16.0D) / 256.0D;
            var24 = ((double)(var19 + 16) - var12 * 16.0D) / 256.0D;
            var22 = ((double)var18 + var16 * 16.0D - 0.01D) / 256.0D;
            var26 = ((double)(var19 + 16) - var47 * 16.0D - 0.01D) / 256.0D;
        ...
        {
            var20 = ((double)(var18 + 16) - var16 * 16.0D) / 256.0D;
            var24 = ((double)var19 + var47 * 16.0D) / 256.0D;
            var22 = ((double)(var18 + 16) - var14 * 16.0D - 0.01D) / 256.0D;
            var26 = ((double)var19 + var12 * 16.0D - 0.01D) / 256.0D;
        ...
        {
            var20 = ((double)(var18 + 16) - var47 * 16.0D - 0.01D) / 256.0D;
            var22 = ((double)(var18 + 16) - var12 * 16.0D) / 256.0D;
            var24 = ((double)(var19 + 16) - var14 * 16.0D - 0.01D) / 256.0D;
            var26 = ((double)(var19 + 16) - var16 * 16.0D) / 256.0D;
        ...
        this.uvRotateBottom = 0;
        this.flipTexture = false;
        var36 = par2 + par1Block.minX;
        double var38 = par2 + par1Block.maxX;
        double var40 = par4 + par1Block.minY;
        double var42 = par6 + par1Block.minZ;
        double var44 = par6 + par1Block.maxZ;
        ...
        if (this.enableAO)
        {
            ...
            var9.addVertexWithUV(var36, var40, var44, var30, var34);
            ...
            var9.addVertexWithUV(var36, var40, var42, var20, var24);
            ...
            var9.addVertexWithUV(var38, var40, var42, var28, var32);
            ...
            var9.addVertexWithUV(var38, var40, var44, var22, var26);
        }
        else
        {
            var9.addVertexWithUV(var36, var40, var44, var30, var34);
    ...
    public void renderTopFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        if (Config.isNaturalTextures() && this.overrideBlockTexture < 0 && this.uvRotateTop == 0)
        {
            ...
            if (var46 != null)
            {
                var11 = Config.getRandom((int)par2, (int)par4, (int)par6, 1);

                if (var46.rotation > 1)
                {
                    this.uvRotateTop = var11 & 3;
                }
        ...
        var36 = par2 + par1Block.minX;
        double var38 = par2 + par1Block.maxX;
        double var40 = par4 + par1Block.maxY;
        double var42 = par6 + par1Block.minZ;
        double var44 = par6 + par1Block.maxZ;
    ...
    public void renderEastFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        if (Config.isNaturalTextures() && this.overrideBlockTexture < 0 && this.uvRotateEast == 0)
        {
            ...
            if (var46 != null)
            {
                var11 = Config.getRandom((int)par2, (int)par4, (int)par6, 2);

                if (var46.rotation > 1)
                {
                    this.uvRotateEast = var11 & 3;
                }
        ...
        double var47 = par1Block.minX;
        double var12 = par1Block.maxX;
        double var14 = par1Block.minY;
        double var16 = par1Block.maxY;
        ...
        double var20 = ((double)var18 + var47 * 16.0D) / 256.0D;
        double var22 = ((double)var18 + var12 * 16.0D - 0.01D) / 256.0D;
        double var24 = ((double)(var19 + 16) - var16 * 16.0D) / 256.0D;
        double var26 = ((double)(var19 + 16) - var14 * 16.0D - 0.01D) / 256.0D;
        double var28;
        ...
        {
            var20 = ((double)var18 + var14 * 16.0D) / 256.0D;
            var24 = ((double)(var19 + 16) - var47 * 16.0D - 0.01D) / 256.0D;
            var22 = ((double)var18 + var16 * 16.0D - 0.01D) / 256.0D;
            var26 = ((double)(var19 + 16) - var12 * 16.0D) / 256.0D;
        ...
        {
            var20 = ((double)(var18 + 16) - var16 * 16.0D) / 256.0D;
            var24 = ((double)var19 + var12 * 16.0D - 0.01D) / 256.0D;
            var22 = ((double)(var18 + 16) - var14 * 16.0D - 0.01D) / 256.0D;
            var26 = ((double)var19 + var47 * 16.0D) / 256.0D;
        ...
        else if (this.uvRotateEast == 3)
        {
            var20 = ((double)(var18 + 16) - var47 * 16.0D - 0.01D) / 256.0D;
            var22 = ((double)(var18 + 16) - var12 * 16.0D) / 256.0D;
            var24 = ((double)var19 + var16 * 16.0D - 0.01D) / 256.0D;
            var26 = ((double)var19 + var14 * 16.0D) / 256.0D;
        ...
        double var38 = par2 + par1Block.maxX;
        double var40 = par4 + par1Block.minY;
        double var42 = par4 + par1Block.maxY;
        double var44 = par6 + par1Block.minZ;

        if (this.enableAO)
        {
            var9.setColorOpaque_F(this.colorRedTopLeft, this.colorGreenTopLeft, this.colorBlueTopLeft);
            var9.setBrightness(this.brightnessTopLeft);
            var9.addVertexWithUV(var36, var42, var44, var28, var32);
            var9.setColorOpaque_F(this.colorRedBottomLeft, this.colorGreenBottomLeft, this.colorBlueBottomLeft);
            var9.setBrightness(this.brightnessBottomLeft);
            var9.addVertexWithUV(var38, var42, var44, var20, var24);
            var9.setColorOpaque_F(this.colorRedBottomRight, this.colorGreenBottomRight, this.colorBlueBottomRight);
            var9.setBrightness(this.brightnessBottomRight);
            var9.addVertexWithUV(var38, var40, var44, var30, var34);
            var9.setColorOpaque_F(this.colorRedTopRight, this.colorGreenTopRight, this.colorBlueTopRight);
            var9.setBrightness(this.brightnessTopRight);
            var9.addVertexWithUV(var36, var40, var44, var22, var26);
        }
        else
        {
            var9.addVertexWithUV(var36, var42, var44, var28, var32);
    ...
    public void renderWestFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        if (Config.isNaturalTextures() && this.overrideBlockTexture < 0 && this.uvRotateWest == 0)
        {
            ...
            if (var46 != null)
            {
                var11 = Config.getRandom((int)par2, (int)par4, (int)par6, 3);

                if (var46.rotation > 1)
                {
                    this.uvRotateWest = var11 & 3;
                }
        ...
        if (this.enableAO)
        {
            var9.setColorOpaque_F(this.colorRedTopLeft, this.colorGreenTopLeft, this.colorBlueTopLeft);
            var9.setBrightness(this.brightnessTopLeft);
            var9.addVertexWithUV(var36, var42, var44, var20, var24);
            var9.setColorOpaque_F(this.colorRedBottomLeft, this.colorGreenBottomLeft, this.colorBlueBottomLeft);
            var9.setBrightness(this.brightnessBottomLeft);
            var9.addVertexWithUV(var36, var40, var44, var30, var34);
            var9.setColorOpaque_F(this.colorRedBottomRight, this.colorGreenBottomRight, this.colorBlueBottomRight);
            ...
            var9.setColorOpaque_F(this.colorRedTopRight, this.colorGreenTopRight, this.colorBlueTopRight);
            var9.setBrightness(this.brightnessTopRight);
            var9.addVertexWithUV(var38, var42, var44, var28, var32);
        }
        else
        {
            var9.addVertexWithUV(var36, var42, var44, var20, var24);
    ...
    public void renderNorthFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        if (Config.isNaturalTextures() && this.overrideBlockTexture < 0 && this.uvRotateNorth == 0)
        {
            ...
            if (var46 != null)
            {
                var11 = Config.getRandom((int)par2, (int)par4, (int)par6, 4);

                if (var46.rotation > 1)
                {
                    this.uvRotateNorth = var11 & 3;
                }
        ...
        double var47 = par1Block.minZ;
        double var12 = par1Block.maxZ;
        double var14 = par1Block.minY;
        double var16 = par1Block.maxY;
        ...
        this.flipTexture = false;
        var36 = par2 + par1Block.minX;
        double var38 = par4 + par1Block.minY;
        double var40 = par4 + par1Block.maxY;
        double var42 = par6 + par1Block.minZ;
        double var44 = par6 + par1Block.maxZ;
        ...
        if (this.enableAO)
        {
            var9.setColorOpaque_F(this.colorRedTopLeft, this.colorGreenTopLeft, this.colorBlueTopLeft);
            var9.setBrightness(this.brightnessTopLeft);
            var9.addVertexWithUV(var36, var40, var44, var28, var32);
            var9.setColorOpaque_F(this.colorRedBottomLeft, this.colorGreenBottomLeft, this.colorBlueBottomLeft);
            var9.setBrightness(this.brightnessBottomLeft);
            var9.addVertexWithUV(var36, var40, var42, var20, var24);
            var9.setColorOpaque_F(this.colorRedBottomRight, this.colorGreenBottomRight, this.colorBlueBottomRight);
            var9.setBrightness(this.brightnessBottomRight);
            var9.addVertexWithUV(var36, var38, var42, var30, var34);
            var9.setColorOpaque_F(this.colorRedTopRight, this.colorGreenTopRight, this.colorBlueTopRight);
            var9.setBrightness(this.brightnessTopRight);
            var9.addVertexWithUV(var36, var38, var44, var22, var26);
        }
        else
        {
            var9.addVertexWithUV(var36, var40, var44, var28, var32);
    ...
    public void renderSouthFace(Block par1Block, double par2, double par4, double par6, int par8)
    {
        ...
        if (Config.isNaturalTextures() && this.overrideBlockTexture < 0 && this.uvRotateSouth == 0)
        {
            ...
            if (var46 != null)
            {
                var11 = Config.getRandom((int)par2, (int)par4, (int)par6, 5);

                if (var46.rotation > 1)
                {
                    this.uvRotateSouth = var11 & 3;
                }
        ...
        if (this.enableAO)
        {
            var9.setColorOpaque_F(this.colorRedTopLeft, this.colorGreenTopLeft, this.colorBlueTopLeft);
            var9.setBrightness(this.brightnessTopLeft);
            var9.addVertexWithUV(var36, var38, var44, var30, var34);
            var9.setColorOpaque_F(this.colorRedBottomLeft, this.colorGreenBottomLeft, this.colorBlueBottomLeft);
            var9.setBrightness(this.brightnessBottomLeft);
            var9.addVertexWithUV(var36, var38, var42, var22, var26);
            var9.setColorOpaque_F(this.colorRedBottomRight, this.colorGreenBottomRight, this.colorBlueBottomRight);
            var9.setBrightness(this.brightnessBottomRight);
            var9.addVertexWithUV(var36, var40, var42, var28, var32);
            var9.setColorOpaque_F(this.colorRedTopRight, this.colorGreenTopRight, this.colorBlueTopRight);
            var9.setBrightness(this.brightnessTopRight);
            var9.addVertexWithUV(var36, var40, var44, var20, var24);
        }
        else
        {
            var9.addVertexWithUV(var36, var38, var44, var30, var34);
