...
public class RenderGlobal implements IWorldAccess
{
    ...
    public void loadRenderers()
    {
        if (this.theWorld != null)
        {
            ...
            {
                for (var3 = 0; var3 < this.worldRenderers.length; ++var3)
                {
                    WorldRenderer var4 = this.worldRenderers[var3];
                    var4.stopRendering();
                }
            }

            var3 = 64 << 3 - this.renderDistance;
            short var11 = 512;
            var3 = 2 * this.mc.gameSettings.ofRenderDistanceFine;

            if (Config.isLoadChunksFar() && var3 < var11)
            {
                var3 = var11;
            }

            var3 += Config.getPreloadedChunks() * 2 * 16;
            short var5 = 400;
            ...
            this.renderChunksWide = var3 / 16 + 1;
            this.renderChunksTall = 16;
            this.renderChunksDeep = var3 / 16 + 1;
            ...
            for (var7 = 0; var7 < this.renderChunksWide; ++var7)
            {
                for (int var13 = 0; var13 < this.renderChunksTall; ++var13)
                {
                    ...
                    {
                        int var10 = (var9 * this.renderChunksTall + var13) * this.renderChunksWide + var7;
                        this.worldRenderers[var10] = new WorldRenderer(this.theWorld, this.tileEntities, var7 * 16, var13 * 16, var9 * 16, this.glRenderListBase + var1);

                        if (this.occlusionEnabled)
                        {
                            this.worldRenderers[var10].glOcclusionQuery = this.glOcclusionQueryBase.get(var2);
                        }
                        ...
                        this.worldRenderers[var10].chunkIndex = var2++;
    ...
    public void renderSky(float par1)
    {
        ...
        {
            GL11.glDisable(GL11.GL_TEXTURE_2D);
            Vec3 var20 = this.theWorld.getSkyColor(this.mc.renderViewEntity, par1);
            var20 = CustomColorizer.getSkyColor(var20, this.mc.theWorld, this.mc.renderViewEntity.posX, this.mc.renderViewEntity.posY + 1.0D, this.mc.renderViewEntity.posZ);
            float var21 = (float)var20.xCoord;
            float var4 = (float)var20.yCoord;
            float var5 = (float)var20.zCoord;
            float var6;

            if (this.mc.gameSettings.anaglyph)
            {
                float var7 = (var21 * 30.0F + var4 * 59.0F + var5 * 11.0F) / 100.0F;
                float var8 = (var21 * 30.0F + var4 * 70.0F) / 100.0F;
                var6 = (var21 * 30.0F + var5 * 70.0F) / 100.0F;
                var21 = var7;
                var4 = var8;
                var5 = var6;
            }

            GL11.glColor3f(var21, var4, var5);
            ...
            GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
            RenderHelper.disableStandardItemLighting();
            float[] var23 = this.theWorld.provider.calcSunriseSunsetColors(this.theWorld.getCelestialAngle(par1), par1);
            float var9;
            float var10;
            float var11;
            float var12;
            ...
            if (var23 != null && Config.isSunMoonEnabled())
            {
                GL11.glDisable(GL11.GL_TEXTURE_2D);
                ...
                var22.setColorRGBA_F(var6, var9, var10, var23[3]);
                var22.addVertex(0.0D, 100.0D, 0.0D);
                byte var14 = 16;
                var22.setColorRGBA_F(var23[0], var23[1], var23[2], 0.0F);
                ...
                for (var15 = 0; var15 <= var14; ++var15)
                {
                    ...
                    var22.addVertex((double)(var16 * 120.0F), (double)(var17 * 120.0F), (double)(-var17 * 40.0F * var23[3]));
                }
            ...
            if (Config.isSunMoonEnabled())
            {
                ...
                var22.addVertexWithUV((double)(-var12), 100.0D, (double)(-var12), 0.0D, 0.0D);
                var22.addVertexWithUV((double)var12, 100.0D, (double)(-var12), 1.0D, 0.0D);
                var22.addVertexWithUV((double)var12, 100.0D, (double)var12, 1.0D, 1.0D);
                var22.addVertexWithUV((double)(-var12), 100.0D, (double)var12, 0.0D, 1.0D);
                var22.draw();
                var12 = 20.0F;
                GL11.glBindTexture(GL11.GL_TEXTURE_2D, this.renderEngine.getTexture("/terrain/moon_phases.png"));
                int var24 = this.theWorld.getMoonPhase(par1);
                int var25 = var24 % 4;
                var15 = var24 / 4 % 2;
                var16 = (float)(var25 + 0) / 4.0F;
                var17 = (float)(var15 + 0) / 2.0F;
                float var18 = (float)(var25 + 1) / 4.0F;
                float var19 = (float)(var15 + 1) / 2.0F;
                var22.startDrawingQuads();
                var22.addVertexWithUV((double)(-var12), -100.0D, (double)var12, (double)var18, (double)var19);
                var22.addVertexWithUV((double)var12, -100.0D, (double)var12, (double)var16, (double)var19);
                var22.addVertexWithUV((double)var12, -100.0D, (double)(-var12), (double)var16, (double)var17);
                var22.addVertexWithUV((double)(-var12), -100.0D, (double)(-var12), (double)var18, (double)var17);
                var22.draw();
            }
            ...
            double var26 = this.mc.thePlayer.getPosition(par1).yCoord - this.theWorld.getHorizon();
            ...
            if (var26 < 0.0D)
            {
                ...
                GL11.glPopMatrix();
                var10 = 1.0F;
                var11 = -((float)(var26 + 65.0D));
                var12 = -var10;
                var22.startDrawingQuads();
                var22.setColorRGBA_I(0, 255);
                var22.addVertex((double)(-var10), (double)var11, (double)var10);
                var22.addVertex((double)var10, (double)var11, (double)var10);
                var22.addVertex((double)var10, (double)var12, (double)var10);
                var22.addVertex((double)(-var10), (double)var12, (double)var10);
                var22.addVertex((double)(-var10), (double)var12, (double)(-var10));
                var22.addVertex((double)var10, (double)var12, (double)(-var10));
                var22.addVertex((double)var10, (double)var11, (double)(-var10));
            ...
            {
                GL11.glColor3f(var21 * 0.2F + 0.04F, var4 * 0.2F + 0.04F, var5 * 0.6F + 0.1F);
            }
            else
            {
                GL11.glColor3f(var21, var4, var5);
            ...
            GL11.glPushMatrix();
            GL11.glTranslatef(0.0F, -((float)(var26 - 16.0D)), 0.0F);
        ...
        else
        {
            ...
            if (var7 != null)
            {
                ...
                for (var15 = 0; var15 < this.worldRenderersToUpdate.size() && var3 < var4; ++var15)
                {
                    ...
                    if (var18 != null)
                    {
                        float var13 = var18.distanceToEntitySquared(par1EntityLiving);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (par1Str.startsWith("iconcrack_"))
                        {
                            ...
                            var22 = Item.itemsList[var27];
                        }
                        else if (par1Str.startsWith("tilecrack_"))
                        {
                            var27 = Integer.parseInt(par1Str.substring(par1Str.indexOf("_") + 1));
                            var21 = new EntityDiggingFX(this.theWorld, par2, par4, par6, par8, par10, par12, Block.blocksList[var27], 0, 0);
                            var22 = Item.itemsList[var27];
                        }
                    }
    ...
    public void obtainEntitySkin(Entity par1Entity)
    {
        ...
        if (par1Entity.cloakUrl != null)
        {
            ...
            if (par1Entity instanceof EntityPlayer)
            {
                ...
                String var4 = "http://optifine.net/capes/" + var2.username + ".png";
